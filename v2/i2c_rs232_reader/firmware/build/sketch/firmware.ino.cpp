#include <Arduino.h>
#line 1
#line 1 "/media/rajesh/Bharadwaja/repos/working/sensors/v2/i2c_rs232_reader/firmware/firmware.ino"
#include <Wire.h>
// #define human 0x01
char data_buffer[255], i = 0;

#line 5 "/media/rajesh/Bharadwaja/repos/working/sensors/v2/i2c_rs232_reader/firmware/firmware.ino"
void setup();
#line 10 "/media/rajesh/Bharadwaja/repos/working/sensors/v2/i2c_rs232_reader/firmware/firmware.ino"
void loop();
#line 5
void setup() {
