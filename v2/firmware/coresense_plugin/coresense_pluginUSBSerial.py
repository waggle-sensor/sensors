...
sensor_list = ["Board MAC","TMP112","HTU21D","GP2Y1010AU0F","BMP180","PR103J2","TSL250RD_1","MMA8452Q","SPV1840LR5H-B_1","TSYS01","HMC5883L","HIH6130","APDS-9006-020","TSL260RD","TSL250RD_2","MLX75305","ML8511","D6T","MLX90614","TMP421","SPV1840LR5H-B_2","Total reducing gases","Ethanol (C2H5-OH)","Nitrogen Di-oxide (NO2)","Ozone (03)","Hydrogen Sulphide (H2S)","Total Oxidizing gases","Carbon Monoxide (C0)","Sulfur Dioxide (SO2)","SHT25","LPS25H","Si1145","Intel MAC","CO ADC temp","IAQ/IRR ADC temp","O3/NO2 ADC temp","SO2/H2S ADC temp","CO LMP temp","Accelerometer","Gyroscope"]
...
# #"GP2Y1010AU0F" is not being used
#     elif sensor_id == '3':
#         print "Sensor:", sensor_id,sensor_list[int(sensor_id)],'@ ',
